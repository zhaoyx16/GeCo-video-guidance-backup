...
from pipeline_wan_i2v_c2f_memory_margin import WanImageToVideoPipeline
...
parser.add_argument("--attn_avg_match_margin", type=float, default=0.0)
...
print("attn_avg_match_margin:", args.attn_avg_match_margin)
...
output = pipe(
    ...
    attn_avg_match_margin=args.attn_avg_match_margin,
