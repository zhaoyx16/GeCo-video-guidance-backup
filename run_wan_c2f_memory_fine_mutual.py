...
from pipeline_wan_i2v_c2f_memory_fine_mutual import WanImageToVideoPipeline
...
parser.add_argument("--attn_avg_match_fine_mutual", action=argparse.BooleanOptionalAction, default=False)
...
print("attn_avg_match_fine_mutual:", args.attn_avg_match_fine_mutual)
...
output = pipe(
    ...
    attn_avg_match_fine_mutual=args.attn_avg_match_fine_mutual,
