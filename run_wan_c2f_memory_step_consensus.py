...
from pipeline_wan_i2v_c2f_memory_step_consensus import WanImageToVideoPipeline
...
parser.add_argument("--attn_avg_flow_smooth_sigma", type=float, default=0.0)
parser.add_argument("--attn_avg_step_consistency_sigma", type=float, default=0.0)
...
print("attn_avg_flow_smooth_sigma:", args.attn_avg_flow_smooth_sigma)
print("attn_avg_step_consistency_sigma:", args.attn_avg_step_consistency_sigma)
...
output = pipe(
    ...
    attn_avg_flow_smooth_sigma=args.attn_avg_flow_smooth_sigma,
    attn_avg_step_consistency_sigma=args.attn_avg_step_consistency_sigma,
