    ...
    def __call__(
        ...
        Args:
            ...
            attn_avg_mode (`str`, defaults to `"global"`):
                ...
                `key_match_prev`, `kv_match_prev`, `value_residual_prev`, or `c2f_value_residual_prev`.
        ...
        if attn_avg_mode not in {
            ...
            raise ValueError(
                ...
                "query_match_prev, key_match_prev, kv_match_prev, value_residual_prev, c2f_value_residual_prev"
            )
        ...
        if attn_avg_alpha > 0.0 and attn_avg_layers:
            ...
            def _matched_previous_values(
                ...
                input_grid = input_hidden.reshape(batch_size, num_tokens_t, height_tokens, width_tokens, -1)
                if attn_avg_mode == "c2f_value_residual_prev":
            ...
            class _CorrespondenceKVProcessor:
                ...
                def __call__(
                    ...
                    elif attn_avg_mode in {"value_residual_prev", "c2f_value_residual_prev"}:
